...
### データ・フラッシュ操作に関する注意
 - 標準的に、[ルネサス製 PFDL-T4 ライブラリ](https://www.renesas.com/ja-jp/software/D3016252.html)を利用する前提で、リンクファイルが作られています。
...
### printf を使わずに、format を使う
 ...
 - 但し、推奨しません。
 - 基本的に、C++ では、便利ではあっても危険性の高い関数は使う理由がありません。
 - 代わりに、同じような機能と利便性を提供する「utils::format」を利用して下さい。
 - 使い方は、サンプルに含まれています。
